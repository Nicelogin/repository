...
class Example(QMainWindow):
    ...
    def paint(self):
        ...
        draw1.ellipse((65 - size1, 65 - size1, 65 + size1, 65 + size1), fill=a1)
        draw2.ellipse((65 - size2, 65 - size2, 65 + size2, 65 + size2), fill=a2)
        draw3.ellipse((65 - size3, 65 - size3, 65 + size3, 65 + size3), fill=a3)
        draw4.ellipse((65 - size4, 65 - size4, 65 + size4, 65 + size4), fill=a4)
        draw5.ellipse((65 - size5, 65 - size5, 65 + size5, 65 + size5), fill=a5)
        draw6.ellipse((65 - size6, 65 - size6, 65 + size6, 65 + size6), fill=a6)
        im.save("res.jpg")
        im1.save("res1.jpg")
        im2.save("res2.jpg")
        im3.save("res3.jpg")
